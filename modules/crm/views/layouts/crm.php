...
<html lang="<?= Yii::$app->language ?>">
    ...
    <div class="container">
        <div class="btn-group  ">
            ...
            <a class="btn btn-warning " href="<?= \yii\helpers\Url::to(['/crm/dw/calcseg']) ?>" class="active">Расчет сегментов</a>
            <span ></span>
            <!--</button>-->
            <p></p>
        </div>
        <div class="btn-group  ">
            <!--<button class="btn btn-warning dropdown-toggle" data-toggle="dropdown" >-->
            <a class="btn btn-warning " href="<?= \yii\helpers\Url::to(['/crm/dw/viewseg']) ?>" class="active">Сегменты</a>
            <span ></span>
            <!--</button>-->
            <p></p>
        </div>
